...
.. raw:: html
  ...
  <div style="text-align: center; margin-bottom: 2em;">
    <iframe width="560" height="315" src="https://www.youtube.com/watch?v=o7TUw2SBTi8" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen>
    </iframe>
  </div>
...
The guide assumres that you have prior coding experience, hopefully in Python. It is designed to use just introductory concepts. No Object Oriented Programming (OOP) are used so that students in particular that have completed their first course in coding and know just variables, if statements, loops and functions will be able to follow along.
